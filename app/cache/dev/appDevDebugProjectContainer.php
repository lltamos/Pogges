...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['activity_config_manager'] = new \AppBundle\Component\Activity\ActivityConfigManager(__DIR__, ($this->targetDirs[2].'/../web/activities'), true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('codeages_plugin.theme.templating.locator')), 1 => $this->get('kernel.class_cache.cache_warmer'), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 4 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array(($this->targetDirs[2].'/../web/customize') => 'customize', ($this->targetDirs[2].'/../src/Topxia/WebBundle/Resources/views') => 'topxiaweb', ($this->targetDirs[2].'/../web/themes') => 'theme', ($this->targetDirs[2].'/../plugins') => 'plugins', ($this->targetDirs[2].'/../') => 'root', ($this->targetDirs[2].'/../web/activities') => 'activity')), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, $this->targetDirs[2], array(($this->targetDirs[2].'/../web/customize') => 'customize', ($this->targetDirs[2].'/../src/Topxia/WebBundle/Resources/views') => 'topxiaweb', ($this->targetDirs[2].'/../web/themes') => 'theme', ($this->targetDirs[2].'/../plugins') => 'plugins', ($this->targetDirs[2].'/../') => 'root', ($this->targetDirs[2].'/../web/activities') => 'activity')))));
    }
    ...
    {
        return $this->services['codeages_plugin.dict_collector'] = new \Codeages\PluginBundle\System\DictCollector(array(0 => ($this->targetDirs[3].'/src/AppBundle/Resources/config/dict.zh_CN.yml'), 1 => ($this->targetDirs[3].'/src/AppBundle/Resources/config/dict.en.yml')), __DIR__, true, 'zh_CN');
    }
    ...
    {
        $this->services['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/dev.log'), 300, true, NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'/src/Topxia/MobileBundleV2/Resources/views'), 'TopxiaMobileBundleV2');
        $a->addPath(($this->targetDirs[3].'/vendor/willdurand/js-translation-bundle/Resources/views'), 'BazingaJsTranslation');
        $a->addPath(($this->targetDirs[3].'/vendor/bshaffer/oauth2-server-bundle/OAuth2/ServerBundle/Resources/views'), 'OAuth2Server');
        $a->addPath(($this->targetDirs[3].'/src/CustomBundle/Resources/views'), 'App');
        $a->addPath(($this->targetDirs[3].'/src/CustomBundle/Resources/views'), 'Custom');
        $a->addPath(($this->targetDirs[3].'/src/ApiBundle/Resources/views'), 'Api');
        ...
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'EndroidQrCodeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/endroid/qrcode/src/Bundle'),
                    'namespace' => 'Endroid\\QrCode\\Bundle',
                ),
                'TopxiaWebBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Topxia/WebBundle'),
                    'namespace' => 'Topxia\\WebBundle',
                ),
                'TopxiaAdminBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Topxia/AdminBundle'),
                    'namespace' => 'Topxia\\AdminBundle',
                ),
                'TopxiaMobileBundleV2' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Topxia/MobileBundleV2'),
                ...
                'OAuth2ServerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/bshaffer/oauth2-server-bundle/OAuth2/ServerBundle'),
                    'namespace' => 'OAuth2\\ServerBundle',
                ),
                'CodeagesPluginBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/codeages/plugin-bundle'),
            ...
            'edusoho.activities_dir' => ($this->targetDirs[2].'/../web/activities'),
            'topxia.disk.local_directory' => ($this->targetDirs[2].'/data/udisk'),
