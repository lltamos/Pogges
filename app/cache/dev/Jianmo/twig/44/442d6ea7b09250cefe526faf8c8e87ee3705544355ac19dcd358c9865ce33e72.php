...
class __TwigTemplate_57673defa17202941bc137f963b5e1d28e9c6fa940cb4d181176b4fa377ed446 extends Twig_Template
{
    ...
    {
        $__internal_734847fa499019c4355c92c2b2c297abbc3bd5fe21f4ecf9fbbf083fd88e1f4b = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_734847fa499019c4355c92c2b2c297abbc3bd5fe21f4ecf9fbbf083fd88e1f4b->enter($__internal_734847fa499019c4355c92c2b2c297abbc3bd5fe21f4ecf9fbbf083fd88e1f4b_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "default/header/part/user-inform.html.twig"));

        // line 1
        $context["messageSetting"] = $this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("message");
        // line 2
        $context["newMessageNum"] = $this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "user", array()), "newMessageNum", array());
        // line 3
  ...
  <a class=\"inform-dropdown-toggle\"><i class=\"cd-icon cd-icon-bell\"></i>";
        // line 7
        if ((($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "user", array()), "newNotificationNum", array()) > 0) || (($context["newMessageNum"] ?? $this->getContext($context, "newMessageNum")) > 0))) {
            echo "<span class=\"inform-dropdown-toggle__num cd-badge cd-badge-danger ";
            if ((($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "user", array()), "newNotificationNum", array()) + ($context["newMessageNum"] ?? $this->getContext($context, "newMessageNum"))) > 9)) {
                echo " inform-dropdown-toggle__num--big ";
            }
            echo "\">";
            echo twig_escape_filter($this->env, ($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "user", array()), "newNotificationNum", array()) + ($context["newMessageNum"] ?? $this->getContext($context, "newMessageNum"))), "html", null, true);
            echo "</span>";
        }
        echo "</a>
  <div class=\"dropdown-menu inform-dropdown js-user-nav-dropdown\" role=\"menu\">
    ...
    <div class=\"tab-content\">
      ...
      <div class=\"message-content tab-pane\" role=\"tabpanel\" id=\"message\">
        ...
        $__internal_734847fa499019c4355c92c2b2c297abbc3bd5fe21f4ecf9fbbf083fd88e1f4b->leave($__internal_734847fa499019c4355c92c2b2c297abbc3bd5fe21f4ecf9fbbf083fd88e1f4b_prof);
    ...
    {
        return array (  149 => 47,  145 => 45,  139 => 42,  133 => 41,  129 => 40,  126 => 39,  121 => 36,  119 => 35,  109 => 30,  105 => 28,  99 => 25,  93 => 24,  89 => 23,  86 => 22,  81 => 19,  79 => 18,  73 => 14,  64 => 12,  62 => 11,  49 => 10,  35 => 7,  32 => 6,  28 => 4,  26 => 3,  24 => 2,  22 => 1,);
    }
    ...
    {
        return new Twig_Source("{% set messageSetting = setting('message') %}
...
</li>", "default/header/part/user-inform.html.twig", "/Users/Exx/Desktop/edusoho/app/Resources/views/default/header/part/user-inform.html.twig");
    }
}
